#' Determine which scales should be scored given an individuals responses.
#'
#' This function determines whether there are a sufficient number of item responses 
#' per scale in order to calculate a score
#' @param Yi (numeric vector) with resonse data. Must be named according to CREDI_code. 
...
which_scores<-function(Yi,mest_df,min_items=5){
